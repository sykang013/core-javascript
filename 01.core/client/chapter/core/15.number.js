...
////pow를 만드는 함수 보다는 pow 내부 로직이 어떻게 돌아가겠다 알고있으면 좋겠지.
console.log("pow :", pow);

// 최소, 최대 값 사이 난수 반환 함수

// function getRandomMinMax(min, max) {
//   let getNumber = Math.random() * max + min;
//   return Math.round(getNumber);
// }
